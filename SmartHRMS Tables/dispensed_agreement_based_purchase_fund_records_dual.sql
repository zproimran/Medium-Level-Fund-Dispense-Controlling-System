...
/****** Object:  Table [dbo].[dispensed_agreement_based_purchase_fund_records_dual]    Script Date: 11/26/2025 8:45:03 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[dispensed_agreement_based_purchase_fund_records_dual](
...
ALTER TABLE [dbo].[dispensed_agreement_based_purchase_fund_records_dual] ADD  DEFAULT (getdate()) FOR [created_at]
GO

ALTER TABLE [dbo].[dispensed_agreement_based_purchase_fund_records_dual]  WITH CHECK ADD  CONSTRAINT [FK_dispensed_agreement_based_purchase_fund_request] FOREIGN KEY([request_id])
REFERENCES [dbo].[agreement_based_purchase_fund_requests] ([request_id])
GO

ALTER TABLE [dbo].[dispensed_agreement_based_purchase_fund_records_dual] CHECK CONSTRAINT [FK_dispensed_agreement_based_purchase_fund_request]
GO
