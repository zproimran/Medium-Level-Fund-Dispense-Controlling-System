...
/****** Object:  Table [dbo].[dispensed_purchase_fund_replenish_records_dual]    Script Date: 11/26/2025 8:46:05 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[dispensed_purchase_fund_replenish_records_dual](
...
ALTER TABLE [dbo].[dispensed_purchase_fund_replenish_records_dual] ADD  DEFAULT (getdate()) FOR [created_at]
GO

ALTER TABLE [dbo].[dispensed_purchase_fund_replenish_records_dual]  WITH CHECK ADD  CONSTRAINT [FK_purchase_fund_replenish_dispensed_request] FOREIGN KEY([request_id])
REFERENCES [dbo].[purchase_fund_replenish_requests] ([request_id])
GO

ALTER TABLE [dbo].[dispensed_purchase_fund_replenish_records_dual] CHECK CONSTRAINT [FK_purchase_fund_replenish_dispensed_request]
GO
