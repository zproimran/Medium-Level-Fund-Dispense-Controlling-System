...
/****** Object:  Table [dbo].[dispensed_petty_cash_records_dual]    Script Date: 11/26/2025 8:45:22 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[dispensed_petty_cash_records_dual](
...
ALTER TABLE [dbo].[dispensed_petty_cash_records_dual] ADD  DEFAULT (getdate()) FOR [created_at]
GO

ALTER TABLE [dbo].[dispensed_petty_cash_records_dual]  WITH CHECK ADD  CONSTRAINT [FK_dispensed_request] FOREIGN KEY([request_id])
REFERENCES [dbo].[petty_cash_requests] ([request_id])
GO

ALTER TABLE [dbo].[dispensed_petty_cash_records_dual] CHECK CONSTRAINT [FK_dispensed_request]
GO
