...
public class EmployeeRequestedLeave extends Application {
    private String currentUser;
    private TableView<User> employeeRequestedLeaveTable;
    ...
    public EmployeeRequestedLeave(String username) {
    ...
    private void buildUI() {
        ...
        // Create Table
        createUserTable();
        root.setCenter(employeeRequestedLeaveTable);
    }
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("Requested Leave");
    ...
    private void createUserTable() {
        employeeRequestedLeaveTable = new TableView<>();
        employeeRequestedLeaveTable.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);
        ...
        TableColumn<User, String> requestedDaysCol = new TableColumn<>("Requested Days");
        requestedDaysCol.setCellValueFactory(new PropertyValueFactory<>("requestedDays"));
        
        TableColumn<User, String> dateFromCol = new TableColumn<>("Date From");
        dateFromCol.setCellValueFactory(new PropertyValueFactory<>("dateFrom"));
        
        TableColumn<User, String> dateToCol = new TableColumn<>("Date To");
        dateToCol.setCellValueFactory(new PropertyValueFactory<>("dateTo"));
        
        
        // Add columns to table
        employeeRequestedLeaveTable.getColumns().addAll(employeecodeCol,  fullNameCol, leaveYearCol, leaveTypeCol,requestedDaysCol,dateFromCol,dateToCol);
    }
    ...
    private void fetchUsers() {
     ...
     List<User> users = conn.getUsers();
        ...
        employeeRequestedLeaveTable.setItems(leaveData);
    }
