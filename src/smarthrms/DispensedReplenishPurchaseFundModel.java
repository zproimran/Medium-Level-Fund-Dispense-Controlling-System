...
public class DispensedReplenishPurchaseFundModel {
    ...
    // Default constructor
    public DispensedReplenishPurchaseFundModel() {}

    // Updated constructor with fingerprint parameter
    public DispensedReplenishPurchaseFundModel(String requestId, String requisitionUnit, String reason, 
    ...
    public DispensedReplenishPurchaseFundModel(String requestId, String requisitionUnit, String reason, 
        ...
        this(requestId, requisitionUnit, reason, payee, requestedAmount, givenAmount, givenBy, 
             requestDate, completedDate, null, verificationMethod);
    }
