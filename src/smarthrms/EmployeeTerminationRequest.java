...
public class EmployeeTerminationRequest extends Application {
    ...
    public EmployeeTerminationRequest(String username) {
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("Employee Termination Request");
    ...
    private void createUserTable() {
        ...
        TableColumn<User, Void> activateCol = new TableColumn<>("Terminate Employee");
        activateCol.setCellFactory(param -> new TableCell<User, Void>() {
            ...
            protected void updateItem(Void item, boolean empty) {
                ...
                if (empty) {
                    ...
                    User user = getTableView().getItems().get(getIndex());
                    button.setText(user.getStatus().equals("Active") ? "Request Termination" : "Cancel Termination");
                    setGraphic(button);
                }
            }
        });
