...
public class PurchaseFundReplenishRecordModel {
    ...
    public PurchaseFundReplenishRecordModel(String requestId, String requisitionUnit, String reason, String payee,
    ...
    public PurchaseFundReplenishRecordModel(String requestId, String requisitionUnit, String reason, 
    ...
    // Default constructor
    public PurchaseFundReplenishRecordModel() {
    ...
    // Copy constructor
    public PurchaseFundReplenishRecordModel(PurchaseFundReplenishRecordModel other) {
