...
public class PettyCashCategoryManagementPage extends BorderPane {
    ...
    public PettyCashCategoryManagementPage(String username) {
        ...
        Label header = new Label("Petty Cash Fund Category Management");
    ...
    private VBox createMainCategoryBox() {
        ...
        Label title = new Label("Petty Cash Main Categories");
    ...
    private void loadMainCategories() {
        ObservableList<String> list = categoryDAO.getPettyMainCategories();
    ...
    private void addMainCategory() {
        ...
        dialog.setTitle("Add Petty Cash Main Category");
        dialog.setHeaderText("Enter new petty cash main category:");
        ...
        dialog.showAndWait().ifPresent(name -> {
            ...
            if (categoryDAO.addPettyMainCategory(name.trim())) {
                loadMainCategories();
    ...
    private void editMainCategory() {
        ...
        dialog.setTitle("Edit Petty Cash Main Category");
        ...
        dialog.showAndWait().ifPresent(newName -> {
            ...
            if (categoryDAO.updatePettyMainCategory(selected, newName.trim())) {
                loadMainCategories();
    ...
    private void deleteMainCategory() {
        ...
        ObservableList<String> subCategories = categoryDAO.getPettySubCategories(selected);
        ...
        confirmation.showAndWait().ifPresent(result -> {
            if (result == ButtonType.OK) {
                if (categoryDAO.deletePettyMainCategory(selected)) {
                    loadMainCategories();
    ...
    private VBox createSubCategoryBox() {
        ...
        Label title = new Label("Petty Cash Subcategories");
        title.setStyle("-fx-font-size: 16px; -fx-font-weight: bold;");
    ...
    private void loadSubCategories() {
        ...
        ObservableList<String> subCategories = categoryDAO.getPettySubCategories(selectedMainCategory);
    ...
    private void addSubCategory() {
        ...
        TextInputDialog dialog = new TextInputDialog();
        dialog.setTitle("Add Petty Cash Subcategory");
        ...
        dialog.showAndWait().ifPresent(name -> {
            ...
            if (categoryDAO.addPettySubCategory(selectedMainCategory, name.trim())) {
                loadSubCategories();
    ...
    private void editSubCategory() {
        ...
        TextInputDialog dialog = new TextInputDialog(selected);
        dialog.setTitle("Edit Petty Cash Subcategory");
        ...
        dialog.showAndWait().ifPresent(newName -> {
            ...
            if (categoryDAO.updatePettySubCategory(selectedMainCategory, selected, newName.trim())) {
                loadSubCategories();
    ...
    private void deleteSubCategory() {
        ...
        confirmation.showAndWait().ifPresent(result -> {
            if (result == ButtonType.OK) {
                if (categoryDAO.deletePettySubCategory(selectedMainCategory, selected)) {
                    loadSubCategories();
