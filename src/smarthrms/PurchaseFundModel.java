...
public class PurchaseFundModel {
    ...
    public PurchaseFundModel(String fundId,String monthlyMoment, double acceptedAmount,
    ...
    public void setAcceptedDate(LocalDate requestDate) { this.acceptedDate = acceptedDate; }
